...
contract GShare is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 50,000 tSHAREs
    ...
    uint256 public constant DEV_FUND_POOL_ALLOCATION = 2495 ether;
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("GSHARE", "GSHARE") {
        _mint(msg.sender, 5 ether); // mint 5 TOMB Share for initial pools deployment
